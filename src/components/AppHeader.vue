  ...
  <header :class="[
    ...
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between">
        <RouterLink to="/" :class="[
          'text-emerald-300 font-bold transition-all duration-300',
          'text-4xl'
        ]">
          <div class="flex items-center gap-2">
            <svg :class="[
              ...
              'w-12 h-12'
            ]" viewBox="0 0 192 192" preserveAspectRatio="xMidYMid meet" fill="currentColor">
        ...
        <Button v-if="auth.isAuthenticated" icon="pi pi-sign-out" @click="logout" size="large" rounded label="Logout" />
      </div>
    </div>
  </header>
</template>
