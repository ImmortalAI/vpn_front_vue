      ...
      <DataTable v-model:expandedRows="expandedRows" editMode="cell" :value="servers" dataKey="id"
        ...
        <template #expansion="slotProps">
          <div class="flex flex-col">
            ...
            <div class="flex">
              <FloatLabel class="float-label-spacer">
                <DatePicker v-model="(slotProps.data as Server).starting_date"
              ...
              <FloatLabel class="float-label-spacer">
                <DatePicker v-model="(slotProps.data as Server).closing_date"
          ...
          <div class="flex flex-col">
            ...
            <div class="flex">
              <FloatLabel class="float-label-spacer">
                <InputNumber :inputId="'port-input-' + slotProps.index" v-model="(slotProps.data as Server).panel_port"
                  :useGrouping="false" :min="0" :max="65535" />
